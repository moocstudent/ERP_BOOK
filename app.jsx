...
const THEME_KEY = "erp_book_theme";
const PROGRESS_KEY = "erp_book_progress";
  ...
  return (
    <LangContext.Provider value={lang}>
      <div data-screen-label={screenLabel}>
        ...
        <div className="running-label">{screenLabel} · self-taught erp · 2026</div>
